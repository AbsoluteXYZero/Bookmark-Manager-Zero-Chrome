...
5. After connecting, the sync dialog offers:
   ...
   - **Overwrite Cloud with Local** / **Overwrite Local with Cloud** - Under Cloud Sync Options. Each carries an arrow showing which way your bookmarks move, and names how many would be lost before doing anything.
